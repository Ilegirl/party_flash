  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<ThemeMode>(
      ...
      builder: (context, mode, child) {
        ...
        Color lightTickMarkColor    = const Color(0xFF797979); // 사용자가 원하는 TickMarkColor
        Color lightTrackColor       = const Color(0xFFC9C9C9); // 사용자가 원하는 TrackColor
        Color lightOuterCircleColor = const Color(0xFF797979); // 사용자가 원하는 OuterCircleColor
        Color lightInnerCircleColor = const Color(0xFFDFDFDF); // 사용자가 원하는 InnerCircleColor
        Color lightText             = const Color(0xFF4E4E4E); // 사용자가 원하는 text 색상
        Color darkTickMarkColor     = const Color(0xFFBFBFBF); // 사용자가 원하는 TickMarkColor
        Color darkTrackColor        = const Color(0xFF797979); // 사용자가 원하는 TrackColor
        Color darkOuterCircleColor  = const Color(0xFFD9D9D9); // 사용자가 원하는 OuterCircleColor
        Color darkInnerCircleColor  = const Color(0xFF7882DE); // 사용자가 원하는 InnerCircleColor
        Color darkText              = const Color(0xFFD9D9D9); // 사용자가 원하는 disabled 색상
